...
class ArrayDecoder:
    def __init__(self, broker_numbers, shareholder_numbers, ord_encoded_size, max_tc_size, max_ts_size):
        ...
        self.tc_encoded_size = 1 + broker_numbers + shareholder_numbers + max_tc_size * ord_encoded_size
    ...
    def decode_tc(self, tc_encoded):
        ...
        ords_encoded = tc_encoded[self.shareholder_numbers + self.broker_numbers:]
        ords = []
